...
public class AttractionModel {
    ...
    private void broadcastAttractionLoadedWithLocalBroadcastManager() {
        Toast.makeText(MyanmarAttractionsApp.getContext(), "broadcastAttractionLoadedWithLocalBroadcastManager", Toast.LENGTH_LONG).show();
    ...
    private void broadcastAttractionLoadedWithEventBus() {
        Toast.makeText(MyanmarAttractionsApp.getContext(), "broadcastAttractionLoadedWithEventBus", Toast.LENGTH_LONG).show();
